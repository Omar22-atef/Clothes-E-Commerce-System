  ...
  men: [
    {
      ...
      name: "Colorful Denim Jacket",
      price: 89,
      image: "./img/men/men-1.jfif",
      images: [
        "./img/men/men-1.jfif",
      ...
      colors: ["Neon Green", "Vibrant Yellow", "Hot Pink"],
      sizes: ["S", "M", "L", "XL"],
      description: "Premium washed denim jacket in bright vibrant colors.",
    },
    {
      id: "men-slim-fit-chino",
      name: "Slim Fit Chino",
      price: 65,
      image: "./img/men/men-2.jfif",
      images: [
        "./img/men/men-2.jfif",
  ...
  women: [
    {
      ...
      name: "Colorful Flow Dress",
      price: 92,
      image: "./img/women/women-1.jfif",
      images: [
        "./img/women/women-1.jfif",
        "https://images.unsplash.com/photo-1618677603286-0ec56cb6e1b5?auto=format&fit=crop&w=1400&q=80",
        "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=1400&q=80",
      ],
      colors: ["Pastel Rainbow", "Bright Cyan", "Fuchsia"],
      sizes: ["XS", "S", "M", "L"],
      description: "Airy midi dress designed in striking vibrant colors.",
    },
    {
      id: "women-pleated-maxi-skirt",
      name: "Pleated Maxi Skirt",
      price: 83,
      image: "./img/women/women-2.jfif",
      images: [
        "./img/women/women-2.jfif",
    ...
    },
    {
      ...
      name: "Silk Blouse",
      price: 74,
      image: "./img/women/women-3.jfif",
      images: [
        "./img/women/women-3.jfif",
    ...
    },
    {
      ...
      price: 119,
      image: "./img/women/women-4.jfif",
      images: [
        "./img/women/women-4.jfif",
        "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=1400&q=80",
    ...
    },
    {
      ...
      name: "Rib Knit Top",
      price: 46,
      image: "./img/women/women-5.jfif",
      images: [
        "./img/women/women-5.jfif",
  ...
  kids: [
    {
      ...
      price: 38,
      image: "./img/kids/kids-1.jfif",
      images: [
        "./img/kids/kids-1.jfif",
      ...
      colors: ["Rainbow", "Electric Blue", "Neon Orange"],
      sizes: ["2Y", "4Y", "6Y", "8Y"],
      description: "Super-soft cotton set in playful bright colors.",
    },
    {
      id: "kids-denim-overall",
      name: "Kids Denim Overall",
      price: 44,
      image: "./img/kids/kids-2.jfif",
      images: [
        "./img/kids/kids-2.jfif",
    ...
    },
    {
      ...
      name: "Rainbow Hoodie",
      price: 35,
      image: "./img/kids/kids-3.jfif",
      images: [
        "./img/kids/kids-3.jfif",
    ...
    },
    {
      ...
      name: "Sporty Jogger",
      price: 31,
      image: "./img/kids/kids-4.jfif",
      images: [
        "./img/kids/kids-4.jfif",
    ...
    },
    {
      ...
      name: "Striped Tee",
      price: 24,
      image: "./img/kids/kids-5.jfif",
      images: [
        "./img/kids/kids-5.jfif",
